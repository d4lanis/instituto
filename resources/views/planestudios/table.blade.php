...
<div class="container pt-2">
    <div class="card col-md-12 badge badge-light">
        <div class="d-flex flex-row mx-2 mt-2 mb-1">
            <div class="h4 pt-1">Plan de estudios</div>
            <div class="pt-1">
                <a href="{{route('planEstudios.create')}}" 
    ...
    <div class="card-block">            
        <div id="table-container" class="p-3 col-12">
            ...
            id="planEstudios_table" data-form="deleteForm">
                <thead class="">
                    <tr>
                        <th>Id</th>
...
@push('scripts2')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var expedientes_table = $('#planEstudios_table').DataTable({
                // autoWidth: false,
                responsive: !0,
                select: !0,
                searching: true,
        ...
        $("#search").on('keyup', function() {
            $("#planEstudios_table").DataTable().search( this.value ).draw();
        });
    </script>
@endpush