...
<div class="container pt-2">
    ...
    <div class="card-block">            
        <div id="table-container" class="p-3 col-12">
            ...
            id="eventos_table" data-form="deleteForm">
                <thead class="">
                    <tr>
                        <th>ID</th>
                        <th># Oficio</th>
...
@push('scripts2')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var expedientes_table = $('#eventos_table').DataTable({
                // autoWidth: false,
                responsive: !0,
                select: !0,
                searching: true,
                ...
                columns: [
                    ...
                    {data:'fecha_evento', name:'fecha_evento', visible:false, class:'text-capitalize'},
                    {data:'fecha_evento_str', name:'fecha_evento_str', class:'text-capitalize'},
        ...
        $("#search").on('keyup', function() {
            $("#eventos_table").DataTable().search( this.value ).draw();
        });
    </script>
@endpush