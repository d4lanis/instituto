...
@section('content')
    <div class="container">
        <div class="card col-md-12 badge badge-light d-flex flex-row justify-content-between">
            ...
            <div class="ml-auto d-flex flex-row p-2">
                ...
                <a href="{!! route('eventos.index') !!}" class="pl-2 pt-1">
                <h4>
  ...
  <!-- Gallery view of uploaded images --> 
                            ...
                            @forelse($evento->evidencias as $evidencia)
                            ...
                            <form action="{!! route('evento_evidencia.delete',$evidencia->id) !!}" method="GET">
                            @csrf
...
@push('scripts2')
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{route('evento_evidencia.store', $evento->id)}}',
