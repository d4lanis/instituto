...
<div class="container pt-2">
    <div class="card col-md-12 badge badge-light">
        <div class="d-flex flex-row mx-2 mt-2 mb-1">
            <div class="h4 pt-1">Colegiados</div>
            <div class="pt-1">
                <a href="{{route('colegiados.create')}}" 
    ...
    <div class="card-block">            
        <div id="table-container" class="p-3 col-12">
            ...
            id="colegiados_table" data-form="deleteForm">
                <thead class="">
                    <tr>
                        <th>ID</th>
                        <th># Oficio</th>
...
@push('scripts2')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var expedientes_table = $('#colegiados_table').DataTable({
                // autoWidth: false,
                responsive: !0,
                select: !0,
                searching: true,
                ...
                ajax: {
                        url: "{!! route('colegiados.list') !!}",
                },
                
                //scrollX: false,
                columns: [
                    {data:'id', name:'id',  class:'text-capitalize'},
                    {data:'numero_oficio', name:'numero_oficio',  class:'text-capitalize'},
                    {data:'fecha_solicitud', name:'fecha_solicitud', visible:false, class:'text-capitalize'},
                    {data:'fecha_solicitud_str', name:'fecha_solicitud_str', class:'text-capitalize'},
                    {data:'motivo', name:'motivo', class:'text-capitalize'},
        ...
        $("#search").on('keyup', function() {
            $("#colegiados_table").DataTable().search( this.value ).draw();
        });
    </script>
@endpush