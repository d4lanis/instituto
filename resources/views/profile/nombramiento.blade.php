...
@section('content')
    <div class="row col-12 mt-2">
        <ul class="nav nav-tabs md-tabs col-md-12" id="myTabEx" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" role="tab" href="{{route('profile.referencias')}}">Referencias</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link active" role="tab" href="#">Nombramientos</a>
            </li>
        </ul>            
    </div>
    <div class="col-md-12 mt-4 p-4">        
        @include('profile.forms.nombramiento')
        @include('profile.tables.nombramiento')
    </div>
@endsection
