<form method="POST" id="div_nombramiento_form" action="{{$route}}" enctype="multipart/form-data" style="display:none;">
    @csrf
...
<div class="ml-auto">
<a id="cancel_button" class="nav-link">
...
$("#cancel_button").on('click', function(){  
                $("#div_nombramiento_table").show();
                $("#div_nombramiento_form").hide();
                $("#nombramiento_form")[0].reset();
            });
            $("#save_button").on('click', function(){  
                $("#nombramiento_form")[0].submit();
            });
